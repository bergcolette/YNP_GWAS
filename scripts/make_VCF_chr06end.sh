...
--variant ${mainDir}/YHLB_6.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YHLB_9.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YLGB_1.1_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YLGB_16.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YLGB_18.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YLGB_19.3_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YLGB_20.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YLGB_21.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YLGB_22.1_WGS_AHQTv1_chr06end.g.vcf.gz \
...
--variant ${mainDir}/YLGB_9.1_WGS_AHQTv1_chr06end.g.vcf.gz \
...
--variant ${mainDir}/YMGB_10.2_WGS_AHQTv1_chr06end.g.vcf.gz \
...
--variant ${mainDir}/YSGB_8.2_WGS_AHQTv1_chr06end.g.vcf.gz \
...
--variant ${mainDir}/YUGB_21.2_WGS_AHQTv1_chr06end.g.vcf.gz \
...
--variant ${mainDir}/YUGB_29.4_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YUGB_30.3_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YUGB_34.3_WGS_AHQTv1_chr06end.g.vcf.gz \
...
--variant ${mainDir}/YOJO_3.2_WGS_AHQTv1_chr06end.g.vcf.gz \
...
--variant ${mainDir}/YWTB_1.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YWTB_2.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YWTB_6.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YWTB_7.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/AHQNT_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/AHQT1.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/HLB4-2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/LMC2-3_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/LMC3-1_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/PVS127_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/PVS300_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/PVS329_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/RCT433_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/UGB11-3_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YCGP_1.2_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YGBR_12.1_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YOJO_8.3_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YUGB_24.1_WGS_AHQTv1_chr06end.g.vcf.gz \
--variant ${mainDir}/YWTB_8.2_WGS_AHQTv1_chr06end.g.vcf.gz \
    -O YNP_WGS_chr06end_all.g.vcf.gz
 

java -jar ~/resources/packages/gatk-4.2.6.1/gatk-package-4.2.6.1-local.jar  GenotypeGVCFs \
   -R ${genome} \
   -V ${mainDir}/YNP_WGS_chr06end_all.g.vcf.gz \
   --heterozygosity 0.03 \
